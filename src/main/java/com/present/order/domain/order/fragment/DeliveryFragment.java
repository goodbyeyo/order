package com.present.order.domain.order.fragment;
...
public class DeliveryFragment {
    ...
    public String compositeAddressInfo() {
        return String.format("%s %s %s %s", receiverZipcode, receiverAddress1, receiverAddress2, etcMessage);
    }
}
